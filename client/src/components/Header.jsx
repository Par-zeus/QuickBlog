  ...
  return (
    <div className='mx-8 sm:mx-16 xl:mx-24 relative'>
        <div className='text-center mt-20 mb-8'>
            ...
            <h1 className='text-3xl sm:text-6xl font-semibold sm:leading-16
             ...
             <p className='my-6 sm:my-8 max-w-2xl m-auto max-sm:text-xs text-gray-500'>
                This is your space to think out loud, to share what matters, andto write without filters. Whether it's one word or thousand, your story starts right here.
             </p>
        ...
        <div className='text-center'>
          {
            input && <button onClick={onClear} className='border font-light text-xs px-3 py-1 rounded-sm 
            shadow-custom-sm cursor-pointer'>Clear Section</button>
          }
        </div>
